package com.mooding.admin.common.config;

import com.mooding.admin.common.shiro.JwtFilter;
import com.mooding.admin.common.shiro.ShiroRealm;
...
public class ShiroConfig {
    @Value("${mooding.shiro.excludeUrls}")
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        if(ObjectConvertUtils.isNotEmpty(excludeUrls)){
